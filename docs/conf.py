...
from forte_wrapper import __version__
from forte_wrapper.version import VERSION_SHORT as __version_short__
...
project = u'Forte Wrappers'
copyright = u'2021, Forte'
author = u'Forte'
...
latex_documents = [
    (master_doc, 'forte-wrapper.tex', u'Forte Wrapper Documentation',
     u'Forte', 'manual'),
]
...
man_pages = [
    (master_doc, 'forte-wrapper', u'Forte Wrapper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'forte-wrapper', u'Forte Wrapper Documentation',
     author, 'Forte-wrapper',
     'Wrappers of NLP projects implemented with Forte.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'forte': (
        'https://asyml-forte.readthedocs.io/en/latest/',
        None
    )
